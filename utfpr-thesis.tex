...
\Title{%
   Refatoração da Arquitetura de uma Ferramenta para Aplicação e Identificação Padrões de Projetos
}{%
   Architecture Refactoring of a Tool that Applies and Identifies Design Pattern%
}
