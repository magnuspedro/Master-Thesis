...
The methodology is sketched through the mind map described in Figure \cref{fig-mind-map-methodology}. It is partitioned into six distinct color segments to enhance the elucidation of the process.

\begin{figure}[ht!]
\SetCaptionWidth{\textwidth}
\caption{Mind map representing the improvement methodology}
\label{fig-mind-map-methodology}
