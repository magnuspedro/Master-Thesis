...
%%
%% Observações:
%% 1. Com subdivisões (\MakeAcronyms* em ./utfpr-thesis.tex), os itens são
%%    ordenados pelo rótulo (label), mas conforme o tipo.
%% 2. Sem subdivisões (\MakeAcronyms em ./utfpr-thesis.tex), os itens são
...
%% +========================+==========================================+
%% Impressão da descrição original em inglês (se definida) com um sinal de mais
%% (+) opcional:
%% +=========================+==========================================+
%% | Comando                 | Imprime                                  |
%% +=========================+==========================================+
