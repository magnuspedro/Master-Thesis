...
{August 14, \YearNum}%% Data de aprovação (dia, mês por extenso e ano)
...
\input{./Pre-Textual/Optionals/acknowledgments}
...
\Keyword{4}{microserviços}{microservices}
\Keyword{5}{processo semiautomatizado}{semi-automated process}
